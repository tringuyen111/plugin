...
- **Technical investigation** — reproduces, instruments, forms hypotheses, and establishes technical root-cause evidence under `/diagnosing-bugs` when needed.
...
- postmortem/learning handoff when applicable.
