...
The UI/UX archive also contains no Git metadata. Its root MIT license and retained Apache-2.0 ui-styling notice are preserved in `licenses/` and `THIRD_PARTY_NOTICES.md`.
