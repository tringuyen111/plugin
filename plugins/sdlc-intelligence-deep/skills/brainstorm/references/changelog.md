...
- Chat-only mode does not require a changelog. If the user explicitly materializes a versioned/durable artifact, include changelog semantics only when useful and never claim a durable file write that did not occur.
