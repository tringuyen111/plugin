> **Worked durable Markdown example:** use this only when Markdown is the selected representation. Transfer the reasoning pattern, not the file format or headings.
