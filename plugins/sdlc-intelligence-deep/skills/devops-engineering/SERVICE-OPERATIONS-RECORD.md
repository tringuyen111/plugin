...
- Provider/tool contract and authority/policy revision when acting:
...
- Decision: no action | observe/recheck | bounded routine action | procedure update | switch to RELEASE_CHANGE | diagnosis handoff | incident handoff | Product-learning handoff | capability gap
- Trigger / rationale:
- Next required concern/capability when not owned here:
...
- Next required concern/capability:
