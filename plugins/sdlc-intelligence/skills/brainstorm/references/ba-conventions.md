...
Select the primary artifact language using the precedence in `SKILL.md` and `runtime-portability.md`.
...
1. raw idea/source;
2. previous answers;
3. the full current living brainstorm artifact.
...
## 6. One living artifact, not a transcript

The canonical brainstorm file stores **current consolidated meaning**.
